...
class startWindow(Rectangle):
    def __init__(self,x_pos, y_pos, x_size, y_size, colour, titleFont, mainFont, title, body, screenID):
        super().__init__(x_pos, y_pos, x_size, y_size, colour, titleFont, mainFont, title, body, screenID)
    ...
    def checkForInput(self, position):
        if position[0] in range (self.rect.left, self.rect.right) and position[1] in range (self.rect.top, self.rect.bottom):
            ...
            if self.text_input == "Start!":
                self.rect1=startWindow(50, 50, 500, 400, "Grey", self.titleFont, self.mainFont, self.title, self.body, self.screenID)
            ...
            self.rect1=Rectangle(50, 50, 500, 400, "Grey", self.titleFont, self.mainFont, self.title, self.body, self.screenID)
...
while True:
    for event in pg.event.get():
        ...
        if event.type == pg.MOUSEBUTTONDOWN:
               ...
               startScreen.startButton.rect1.update(pg.mouse.get_pos())
               #startScreen.infoButton.rect1.update(pg.mouse.get_pos())
               #startScreen.rulesButton.rect1.update(pg.mouse.get_pos())
